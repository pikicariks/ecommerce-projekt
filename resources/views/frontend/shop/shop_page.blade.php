...
<div class="body-content outer-top-xs">
 ...
 @foreach($brands as $brand)
  ...
  <label for="" class="form-check-label">
    ...
    @if(session()->get('language') == 'bosnian') {{ $brand->brand_name_hin }} @else {{ $brand->brand_name_en }} @endif
            ...
            <div class="sidebar-widget wow fadeInUp">
              ...
              <div class="sidebar-widget-body m-t-10">
                <div class="price-range-holder"> <span class="min-max"> <span class="pull-left">$200.00</span> <span class="pull-right">$800.00</span> </span>
                  ...
                  <input type="text" class="price-slider" name="PRICE"  >
                </div>
                <!-- /.price-range-holder --> 
                <button type="submit" class="lnk btn btn-primary">Show Now</button> </div>
              <!-- /.sidebar-widget-body --> 
            </div>
            <!-- /.sidebar-widget --> 
            <!-- ============================================== PRICE SILDER : END ============================================== --> 
      ...
      <div class="product">
        ...
        <div class="product-info text-left">
          <h3 class="name"><a href="{{ url('product/details/'.$product->id.'/'.$product->product_slug_en ) }}">
          	@if(session()->get('language') == 'bosnian') {{ $product->product_name_hin }} @else {{ $product->product_name_en }} @endif</a></h3>
...
<div class="product-price"> <span class="price"> ${{ $product->discount_price }} </span> <span class="price-before-discount">$ {{ $product->selling_price }}</span> </div>
            ...
            <div class="description m-t-10">
            	@if(session()->get('language') == 'bosnian') {{ $product->short_desc_hin }} @else {{ $product->short_desc_en }} @endif</div>
            <div class="cart clearfix animate-effect">
              <div class="action">
                <ul class="list-unstyled">
                  <li class="add-cart-button btn-group">

...
<div class="body-content">
	...
	<h1>@if(session()->get('language') == 'bosnian') {{ $blogpost->post_title_bos }} @else {{ $blogpost->post_title_en }} @endif</h1>
	...
	<p> @if(session()->get('language') == 'bosnian') {!!  $blogpost->post_details_bos  !!} @else {!!  $blogpost->post_details_en  !!} @endif
	</p>

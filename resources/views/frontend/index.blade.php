            ...
            @foreach($categories as $category)
              ...
              @endphp
                    ...
                    @foreach($subcategories as $subcategory)
                      <div class="col-sm-12 col-md-3">
                        <h2 class="title">
                        @if(session()->get('language') == 'bosnian') {{$subcategory->subcategory_name_hin}} @else  {{$subcategory->subcategory_name_en}} @endif
              ...
              @foreach($subsubcategories as $ssubcat)
                        <ul class="links list-unstyled">
                          <li><a href="#">  @if(session()->get('language') == 'bosnian')   {{$ssubcat->subsubcategory_name_hin}} @else    {{$ssubcat->subsubcategory_name_en}} @endif

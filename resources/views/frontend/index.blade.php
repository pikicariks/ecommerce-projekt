                        ...
                        <div class="cart clearfix animate-effect">
                          <div class="action">
                            <ul class="list-unstyled">
                              ...
                              <button class="btn btn-primary icon" type="button" id="{{$product->id}}" onclick="addToWish(this.id)" title="Wishlist"> <i class="fa fa-heart"></i> </button>
            ...
            <div class="tab-pane" id="category{{$category->id}}">
              <div class="product-slider">
                <div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
                  ...
                  @php
                  $catProd = App\Models\Product::where('category_id',$category->id)->orderBy('id','DESC')->get();
                  @endphp
...
@endforeach
        ...
        <!-- ============================================== FEATURED PRODUCTS : END ============================================== --> 
          ...
          @if(session()->get('language') == 'bosnian')  {{$skip_cat_0->category_name_hin}} @else  {{$skip_cat_0->category_name_en}} @endif

         </h3>
          <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
            
          @foreach($skip_prod_0 as $product)
          <div class="item item-carousel">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
        ...
        <section class="section featured-product wow fadeInUp">
          <h3 class="section-title">
          @if(session()->get('language') == 'bosnian')  {{$skip_cat_01->category_name_hin}} @else  {{$skip_cat_1->category_name_en}} @endif

         </h3>
          <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
            
          @foreach($skip_prod_1 as $product)
          <div class="item item-carousel">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
        ...
        <section class="section featured-product wow fadeInUp">
          <h3 class="section-title">
          @if(session()->get('language') == 'bosnian')  {{$skip_brand_0->brand_name_hin}} @else  {{$skip_brand_0->brand_name_en}} @endif

         </h3>
          <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
            
          @foreach($skip_brand_prod_0 as $product)
          <div class="item item-carousel">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
            ...
            @foreach($blogpost as $blog)
              <div class="item">
                <div class="blog-post">
                  ...
                  <h3 class="name"><a href="#">@if(session()->get('language') == 'bosnian') {{ $blog->post_title_bos }} @else {{ $blog->post_title_en }} @endif</a></h3>


<span class="info">{{ Carbon\Carbon::parse($blog->created_at)->diffForHumans()  }}</span>

<p class="text">@if(session()->get('language') == 'bosnian') {!! Str::limit($blog->post_details_bos, 100 )  !!} @else {!! Str::limit($blog->post_details_en, 100 )  !!} @endif</p>

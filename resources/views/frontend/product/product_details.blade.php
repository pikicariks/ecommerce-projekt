   ...
   @endif
					...
					<div class="col-sm-8">
						<div class="reviews">
							...
							@if(session()->get('language') == 'bosnian') {{$product->short_desc_hin}} @else  {{$product->short_desc_en}} @endif
							...
							<div class="tab-content">
								...
								<div id="description" class="tab-pane in active">
									<div class="product-tab">
										...
										<p class="text">@if(session()->get('language') == 'bosnian') {!! $product->long_desc_hin !!} @else  {!! $product->long_desc_en !!} @endif
</p>
									</div>	
								</div><!-- /.tab-pane -->
...
@endif
										...
										<div class="product-add-review">
											...
											@guest
<p><b>To add product review you need to login first <a href="{{route('login')}}">Login</a> </b></p>
											@else

...
@csrf
                ...
                <div class="controls">
                    <select name="division_id"  required class="form-control">
                        <option value="" disabled=""  selected="">Selected Division</option>
			...
			<div class="form-group">
                ...
                <div class="controls">
                    <select name="district_id"  required class="form-control">
                        <option value="" disabled="" selected="">Selected District</option>
        ...
        @enderror
			...
			<div class="form-group">
					    <label class="info-title" for="exampleInputEmail1"><b>Notes </b> <span>*</span></label>
					  	<textarea name="notes" cols="30" rows="5" placeholder="Notes"></textarea>
					</div>

...
<div class="row"> <!-- start 2nd row  -->
	 ...
	 @enderror
			...
			<div class="col-md-6">
				 ...
				 <div class="form-group">
			<h5>Post Title Bos <span class="text-danger">*</span></h5>
			<div class="controls">
				<input type="text" name="post_title_bos" class="form-control" required="">
     @error('post_title_bos') 
	 <span class="text-danger">{{ $message }}</span>
	 @enderror
	 		 </div>
		</div>
...
<div class="row"> <!-- start 8th row  -->
	...
	<textarea id="editor1" name="post_details_en" rows="10" cols="80" required="">
		Post Details English
	     ...
	     <div class="form-group">
			<h5>Post Details Bosnian <span class="text-danger">*</span></h5>
			<div class="controls">
	<textarea id="editor2" name="post_details_bos" rows="10" cols="80">
		Post Details Bosnian
						</textarea>       
	 		 </div>
		</div>
